function [y_k, X_k, H_k] = ola(x_k_prev, x_k, h, L)
% OLA  Overlap and add of a signal x passing through a filter h.
%     [y_k, X_k, H_k] = OLA(x_k_prev, x_k, h, L) computes the overlap and add of
